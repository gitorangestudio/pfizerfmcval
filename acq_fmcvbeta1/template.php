 ...
 */
function acq_fmcvbeta1_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _acq_fmcvbeta1_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function acq_fmcvbeta1_html_head_alter(&$head_elements) {
...
function acq_fmcvbeta1_preprocess_page(&$variables) {
  ...
  $layoutClass = _acq_fmcvbeta1_get_layout();
 ...
 */
function acq_fmcvbeta1_preprocess_block(&$vars) {
 ...
 */
function _acq_fmcvbeta1_variable_get($key, $default) {
  global $theme;
 ...
 */
function _acq_fmcvbeta1_get_layout() {
  $layout_patterns = _acq_fmcvbeta1_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function acq_fmcvbeta1_node_view_alter(&$build) {
...
function acq_fmcvbeta1_preprocess_forum_topic_list(&$vars) {
 ...
 */
function acq_fmcvbeta1_preprocess_comment_wrapper(&$vars) {
 ...
 */
function acq_fmcvbeta1_preprocess_media_gallery_license(&$vars) {
